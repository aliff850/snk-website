...
function ConfirmRegistrationContent() {
  ...
  return (
    <section className="w-full min-h-svh bg-[url('/images/w214.jpg')] bg-cover bg-center font-onest">
      <div className="w-full min-h-svh bg-black/50 px-4 md:px-12 lg:px-24 py-16 flex flex-col justify-center items-center">
...
export default function ConfirmRegistration() {
  return (
    <Suspense fallback={<div className="w-full min-h-svh bg-black/50" />}>
