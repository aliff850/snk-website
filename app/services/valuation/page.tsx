...
const allClaimsFeatures = [
  {
    ...
    description:
      "Get instant, up-to-date vehicle valuations at your fingertips.",
  },
  {
    title: "Wide Coverage of Popular Models",
    description:
  ...
  },
  {
    ...
    description:
      "Includes valuations for private cars, lorries, and various body types.",
  },
  {
    title: "Accurate Market Insights",
    description:
      "Reliable data to support sales, purchases, and insurance assessments.",
  },
  {
