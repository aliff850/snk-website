...
export function ProductHero({ title, caption, backgroundImage = '/services/estimation.png' }: ProductHeroProps) {
    return(
        ...
        >
            <div className="w-full h-full bg-black/50 px-4 md:px-12 lg:px-24 pt-32 pb-24 flex flex-col gap-4 lg:gap-8 justify-center items-center">
                <div className="text-center flex flex-col gap-4 lg:gap-8">
                    <AnimateOnLoad animation="fade-in-up">
                        ...
                        <h1 className="text-brand-element text-4xl md:text-5xl font-bold drop-shadow-lg">
                            {title}
                        </h1>
                    </AnimateOnLoad>
                    
                    <AnimateOnLoad animation="fade-in-up" delay={200}>
                        <p className="text-white text-base md:text-lg max-w-4xl mx-auto drop-shadow-lg leading-relaxed">
                            {caption}
                        </p>
                    </AnimateOnLoad>
