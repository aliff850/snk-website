...
export function ValuationBanner() {
    ...
    return(
        <section className="w-full px-4 md:px-12 lg:px-24 py-8 md:py-16 font-onest">
            <AnimateOnLoad animation="fade-in-up">
                <div className="bg-[url('/images/g20.jpg')] bg-cover bg-center rounded-3xl max-w-7xl mx-auto overflow-hidden relative">

                    <div className="bg-black/70 w-full h-full px-4 py-8 md:px-12 md:py-12 lg:px-16 lg:py-16">
                        ...
                        <div className="flex flex-col md:flex-row items-center justify-between gap-6 md:gap-8">
                            ...
                            <div className="flex-shrink-0">
                                <Button 
                                    ...
                                    size="md" 
                                    href="/valuation" 
                                    className="text-base md:text-xl flex gap-2 whitespace-nowrap"
                                >
