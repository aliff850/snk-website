...
export function ReasonSection() {
    ...
    return(
        <section className="w-full bg-brand-element/10 flex flex-col gap-8 justify-center items-center px-4 py-8 md:px-12 lg:px-24 md:py-16 font-onest text-white snap-start">
