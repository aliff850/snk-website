...
export function HeroSection() {
    ...
    return (
        ...
        <section className="bg-brand min-h-screen bg-[url('/images/g70.jpg')] bg-cover bg-center bg-fixed flex flex-col justify-center items-center">
            <div className="min-h-screen w-full bg-black/20 backdrop-blur-sm flex flex-col justify-center items-center px-4 md:px-12 lg:px-24 py-16">
                ...
                <div className="mx-auto max-w-7xl font-onest">
                    ...
                    <div className="text-center">
                        ...
                        <Button variant="secondary" className="text-2xl" size="sm" href="#background">
                            Explore
                            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-chevron-right-icon lucide-chevron-right"><path d="m9 18 6-6-6-6"/></svg>
                        </Button>
