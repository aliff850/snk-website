...
export function HeroSection() {
    ...
    return (
        ...
        <section className="bg-brand min-h-svh bg-[url('/images/w214.jpg')] bg-cover bg-center bg-fixed flex flex-col justify-center items-center">
            <div className="h-svh w-full bg-black/50 flex flex-col justify-center items-center px-2 md:px-12 lg:px-24 py-16">
                ...
                <div className="mx-auto max-w-7xl font-onest">
                    ...
                    <div className="text-center">
                        ...
                        <Button variant="secondary" size="base" href="#clients" className="text-2xl">
                            Explore
