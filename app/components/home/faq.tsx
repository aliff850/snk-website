...
export function FAQSection() {
    ...
    return (
      <section className="bg-brand justify-center items-center px-2 py-4 md:px-12 lg:px-24 md:py-16 font-onest">
        <div className="w-full max-w-7xl mx-auto flex flex-col gap-8">
            ...
            <div className="text-center text-brand-foreground flex flex-col justify-center gap-4 items-center">
                ...
                <Button href="/contact" size="md" className='text-xl md:text-2xl'>
