                ...
                <AnimateOnLoad animation="fade-in-left" className="h-full">
                    <div className="w-full h-full flex flex-col gap-4 justify-center">
                        ...
                        <Button href="/about">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" stroke-linecap="round" stroke-linejoin="round" className="ml-2 lucide lucide-chevron-right-icon lucide-chevron-right"><path d="m9 18 6-6-6-6"/></svg>
                        </Button>
