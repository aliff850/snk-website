...
export function ContactInfo() {
    return (
        <section className="w-full bg-brand py-12 px-4 md:px-12 lg:px-24 font-onest">
            <div className="w-full max-w-7xl mx-auto">

                <AnimateOnLoad animation="fade-in-up">
                    <div className="text-center mb-16">
                        <h2 className="text-white text-3xl md:text-4xl font-bold mb-6">Contact Information</h2>
